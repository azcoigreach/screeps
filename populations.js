...
Standalone: {
	...
	4: {    worker:   {level: 4, amount: 5} ,
			upgrader: {level: 4, amount: 2} },
	5: {    worker:   {level: 5, amount: 4} ,
			upgrader: {level: 5, amount: 2} },
	6: {    worker:   {level: 6, amount: 5} ,
...
Assisted: {
	...
	4: {    worker:   {level: 5, amount: 6} ,
			upgrader: {level: 5, amount: 2} },
	5: {    worker:   {level: 6, amount: 4} ,
			upgrader: {level: 6, amount: 2} },
	6: {    worker:   {level: 7, amount: 5} ,
			upgrader: {level: 7, amount: 2} },
	7: {    worker:   {level: 7, amount: 5} ,
			upgrader: {level: 7, amount: 2} },
	8: {	worker:   {level: 6, amount: 2} ,
			upgrader: {level: 6, amount: 1} } }	
};
...
S2: {
	...
	6: {	burrower:  {level: 6, amount: 2},
			carrier:   {level: 6, amount: 3},
			extractor: {level: 5, amount: 2} },
...
R2: {
	...
	4: {	burrower:  {level: 3, amount: 1, body: "burrower_at"},
			...
			multirole: {level: 3, amount: 1, body: "worker_at"},
			reserver:  {level: 3, amount: 2, body: "reserver_at"} },
	5: {	burrower:  {level: 4, amount: 2, body: "burrower_at"},
			carrier:   {level: 4, amount: 3, body: "carrier_at"},
			multirole: {level: 4, amount: 1, body: "worker_at"},
			reserver:  {level: 4, amount: 2, body: "reserver_at"} },
	6: {	burrower:  {level: 5, amount: 2, body: "burrower_at"},
